...
\begin{frame}{LTL Etude - Propriétés}
    On propose les premières propriétés suivantes:

    \textbf{Propriétés}
    \begin{itemize}
        \item Si le bouton est appuyé, la lumière $l2$ change forcement
        \item Si le bouton est appuyé, la lumière $l1$ change si $\varphi_{l2}$
    \end{itemize}
    \textbf{Traduction}
    \begin{itemize}
        \item $\varphi_{b} \implies (\varphi_{l2} \Leftrightarrow \lnot(X \varphi_{l2}))$
        \item $(\varphi_{b} \land \varphi_{l2}) \implies (\varphi_{l1} \Leftrightarrow \lnot(X \varphi_{l1}))$
    \end{itemize}
\end{frame}

...
\begin{frame}{Définitions}
    \begin{definition}[Logique Propositionelle]
...
\begin{frame}{Conclusion}
    ...
    \begin{itemize}[<+->]
        \item Conversion IMPOSSIBLE (Exemple pour n=2: $a_1\lor a_2$)
...
\begin{frame}{Contexte}
    ...
    \end{definition}
    \begin{definition}[Logique Linéaire Temporelle (LTL)]
...
\begin{frame}{Contraintes}
    ...
    \begin{itemize}
        ...
        \item $X\alpha$ = ce que $\alpha$ est vraie au temps prochain ? ($X$ pour neXt)
    \end{itemize}
\end{frame}
...
\begin{frame}{Exemple d'execution}
    ...
    \textbf{Resultat:} Comptatible

    \centering  
    \includegraphics[width=200px,height=200px,keepaspectratio]{output.jpg}  \vspace{0.5em}
    
    \footnotesize\textbf{Figure:} Capture d'écran du resultat
\end{frame}

\begin{frame}{Conclusion}
    Rappel: On voulait determiner l'utilité de la méthode des tableaux dans différentes logiques.
    \begin{itemize}
        \item Etude de la résolution de SAT et familiarisation avec la méthode 
        \item Application et discution à propos des algorithmes utilisant cette méthode
    \end{itemize}
\end{frame}
